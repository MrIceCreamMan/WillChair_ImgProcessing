...
Mat original, img_edge;	int trackBarVal1 = 0;	int trackBarVal2 = 0;	int trackBarVal3 = 0;	int maxBarValue = 100;
...
void drawConnecttedFromPoint(Mat& original, const Mat& flood_rst, const Point& blackLoc, vector<Point2i>& handle);
void drawConnecttedFromBlob(Mat& original, const Mat& flood_rst, const vector<Point2i> handle, const int& wanted_hues);
...
int main()
{
	...
	// Input images
	original = imread("./door/door_2.jpg");
	...
	//EdgeDetection(original, img_edge, 12, 14, 17);
	...
	drawConnecttedFromPoint(detected_region, flood_rst, blackLoc, handle);
	...
	if (hue_refine == 1)
		drawConnecttedFromBlob(detected_region, img_hue, handle, door_hue_avg);
...
void drawConnecttedFromPoint(Mat& original, const Mat& flood_rst, const Point& blackLoc, vector<Point2i>& blob ) {
...
void drawConnecttedFromBlob(Mat& original, const Mat& flood_rst, const vector<Point2i> handle, const int& wanted_hue) {
